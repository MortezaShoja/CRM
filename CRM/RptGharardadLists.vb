...
Public Class RptGharardadLists
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.RptGharardadLists.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptGharardadLists
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptGharardadLists = New RptGharardadLists()
        rpt.Site = Me.Site
        Return rpt
    End Function
