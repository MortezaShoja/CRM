...
Public Class rptResideDaryaft
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.rptResideDaryaft.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResideDaryaft
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResideDaryaft = New rptResideDaryaft()
        rpt.Site = Me.Site
        Return rpt
    End Function
