...
Public Class rptAghsatTrue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.rptAghsatTrue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAghsatTrue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAghsatTrue = New rptAghsatTrue()
        rpt.Site = Me.Site
        Return rpt
    End Function
