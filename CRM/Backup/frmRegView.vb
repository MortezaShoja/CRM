Public Class frmRegView
    ...
    Private Sub btnReg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReg.Click
        ...
        Cmd.CommandText = "insert into Nama (MajmooeID,Nama) values ('" & MajmooeID & "',N'" & Me.txtView.Text & "')"
    ...
    Private Sub FillGrid()
        ...
        Try
            ...
            Cmd.CommandText = "Select ID as 'کد شناسائی',Nama as 'نما/ دید/ View' from Nama where MajmooeID='" & MajmooeID & "'"
    ...
    Private Sub FillTextBox(ByVal GID As String)
        ...
        Dim cmd As New SqlClient.SqlCommand("Select MajmooeID,Nama from Nama where ID='" & GID & "'", SqlCon.SqlCon)
        ...
        Try
            While sdr.Read
                ...
                Me.txtView.Text = sdr(1).ToString
    ...
    Private Sub DbgView_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DbgView.CellClick
        Try
            ...
            ViewID = Me.DbgView.CurrentRow.Cells.Item(0).Value.ToString
        Catch ex As Exception
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Cmd.CommandText = "delete Nama where ID='" & ViewID & "'"
        Cmd.Connection = SqlCon.SqlCon
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        Cmd.CommandText = "Update Nama set MajmooeID='" & MajmooeID & "',Nama=N'" & Me.txtView.Text & "' where ID='" & ViewID & "'"
        Cmd.Connection = SqlCon.SqlCon
