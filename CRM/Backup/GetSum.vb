Public Class GetSum
    ...
    Public Function GetSum(ByVal OwnerID As String, ByVal Type As String)
        ...
        Dim cmd As New SqlClient.SqlCommand("Select sum(price) from Bank where ID=N'" & OwnerID & "' AND Pardakhte=N'" & Type & "' AND Pardakhte!=N'سایر پرداخت ها'", SqlConGetSum.SqlCon)
    ...
    Public Function GetSumPardakhtShode(ByVal OwnerID As String, ByVal Type As String)
        ...
        Dim cmd As New SqlClient.SqlCommand("Select sum(price) from Bank where ID=N'" & OwnerID & "' AND Pardakhte=N'" & Type & "' AND Passed='1'", SqlConGetSum.SqlCon)
        Dim Sum As String = String.Empty
        SqlConGetSum.SqlCon.Close()
        SqlConGetSum.SqlCon.Open()
        Dim sdr As SqlClient.SqlDataReader = cmd.ExecuteReader
    ...
    Public Function GetSumPardakhtNaShode(ByVal OwnerID As String, ByVal Type As String)
        ...
        Dim cmd As New SqlClient.SqlCommand("Select sum(price) from Bank where ID=N'" & OwnerID & "' AND Pardakhte=N'" & Type & "' AND Passed='0'", SqlConGetSum.SqlCon)
        Dim Sum As String = String.Empty
        SqlConGetSum.SqlCon.Close()
        SqlConGetSum.SqlCon.Open()
        Dim sdr As SqlClient.SqlDataReader = cmd.ExecuteReader
    ...
    Public Function GetCount(ByVal OwnerID As String, ByVal Type As String)
        ...
        Dim cmd As New SqlClient.SqlCommand("Select Count(price) from Bank where ID=N'" & OwnerID & "' AND Pardakhte=N'" & Type & "'", SqlConGetSum.SqlCon)
        Dim Sum As String = String.Empty
        SqlConGetSum.SqlCon.Close()
        SqlConGetSum.SqlCon.Open()
        Dim sdr As SqlClient.SqlDataReader = cmd.ExecuteReader
