...
Public Class rptPishGhrardad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.rptPishGhrardad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPishGhrardad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPishGhrardad = New rptPishGhrardad()
        rpt.Site = Me.Site
        Return rpt
    End Function
