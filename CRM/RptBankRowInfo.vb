...
Public Class RptBankRowInfo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.RptBankRowInfo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBankRowInfo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBankRowInfo = New RptBankRowInfo()
        rpt.Site = Me.Site
        Return rpt
    End Function
