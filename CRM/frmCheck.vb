Public Class frmPardakhteCheck
    ...
    Public GharardadPrice, Price, Saghf As String
    ...
    Private Sub btnReg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReg.Click
        ...
        Cmd.CommandText = "insert into " & DbName & " (ID,price,accountOwner,accountNo,Serial,ownerBank,bankShobe,bankCode,Date,Tozihat,Passed,RegDate,RegDay,Pardakhte,FormType,Jahate,PardakhtDate) values ('" & OwnerID & "','" & Cu.DeCodeNumber(Me.txtPrice.Text) & "',N'" & Me.txtAccountOwner.Text & "',N'" & Me.txtAccountNo.Text & "',N'" & Me.txtCheckNo.Text & "',N'" & Me.txtBank.Text & "',N'" & Me.txtShobeName.Text & "',N'" & Me.txtShobeCode.Text & "',N'" & Me.txtDate.Text & "',N'" & Me.txtTozihat.Text & "','" & Me.ChkPardakhtShod.Checked & "',N'" & Date1 & "',N'" & Day1 & "',N'" & Type & "',N'" & FormType & "',N'" & Me.cboSayerJahate.Text & "',N'" & Me.txtPardakhtDate.Text & "')"
    ...
    Private Sub FillGrid()
        ...
        Try
            Cmd.CommandText = "Select  Row_Number() Over(order by Date Desc) as 'ردیف', Passed as 'وضعیت پرداخت',Serial as 'شمار چک',price as 'مبلغ چک',accountOwner as 'نام صاحب حساب',ownerBank as 'عهده بانک',date as 'تاریخ سر رسید',Row as 'کد شناسائی'  from " & DbName & " where ID=N'" & OwnerID & "'  and Pardakhte=N'" & Type & "' And FormType=N'" & FormType & "' order by RegDate"
    ...
    Private Sub FillTextBox(ByVal Row As String)
        ...
        Dim cmd As New SqlClient.SqlCommand("SELECT price,accountOwner,accountNo,Serial,ownerBank,bankShobe,bankCode,Date,Tozihat,Passed,Jahate,PardakhtDate From " & DbName & " where Row='" & Row & "'", SqlCon.SqlCon)
        ...
        Try
            While sdr.Read
                ...
                Me.txtAccountOwner.Text = sdr(1).ToString
                Me.txtAccountNo.Text = sdr(2).ToString
                Me.txtCheckNo.Text = sdr(3).ToString
                Me.txtBank.Text = sdr(4).ToString
                Me.txtShobeName.Text = sdr(5).ToString
                Me.txtShobeCode.Text = sdr(6).ToString
                Me.txtDate.Text = sdr(7).ToString
        ...
        End Try
        ChkChecked()
        Me.txtSumPrice.Text = GetSumAll(DbName, Me.txtCheckNo.Text)
    End Sub
    ...
    Private Sub dbgCheck_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dbgCheck.CellClick
        Try
            Row = Me.dbgCheck.CurrentRow.Cells.Item(7).Value.ToString
            FillTextBox(Row)
        Catch ex As Exception
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        ...
        If Result = Windows.Forms.DialogResult.Yes Then
            Cmd.CommandText = "Update " & DbName & " Set price=" & Cu.DeCodeNumber(Me.txtPrice.Text) & ",accountOwner=N'" & Me.txtAccountOwner.Text & "',accountNo=N'" & Me.txtAccountNo.Text & "',Serial=N'" & Me.txtCheckNo.Text & "',ownerBank=N'" & Me.txtBank.Text & "',bankShobe=N'" & Me.txtShobeName.Text & "',bankCode=N'" & Me.txtShobeCode.Text & "',Date=N'" & Me.txtDate.Text & "',Tozihat=N'" & Me.txtTozihat.Text & "',Passed='" & Me.ChkPardakhtShod.Checked & "',RegDate=N'" & Date1 & "',RegDay=N'" & Day1 & "',Jahate=N'" & Me.cboSayerJahate.Text & "',PardakhtDate=N'" & Me.txtPardakhtDate.Text & "' where Row='" & Row & "'"
    ...
    Private Sub btnCopy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCopy.Click
        Tmp(0) = Me.txtAccountOwner.Text
        Tmp(1) = Me.txtAccountNo.Text
        Tmp(2) = Me.txtBank.Text
        Tmp(3) = Me.txtShobeName.Text
        Tmp(4) = Me.txtShobeCode.Text
    End Sub

    Private Sub bntPaste_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bntPaste.Click
        Me.txtAccountOwner.Text = Tmp(0)
        Me.txtAccountNo.Text = Tmp(1)
        Me.txtBank.Text = Tmp(2)
        Me.txtShobeName.Text = Tmp(3)
        Me.txtShobeCode.Text = Tmp(4)
        Me.txtCheckNo.Focus()
    End Sub
    ...
    Private Sub txtCheckNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtCheckNo.KeyPress
        ...
        If e.KeyChar = Chr(123) Then
            ...
            Dim cmd As New SqlClient.SqlCommand("SELECT price,accountOwner,accountNo,Serial,ownerBank,bankShobe,bankCode,Date,Tozihat,Passed,Jahate,PardakhtDate From " & DbName & " where Serial=N'" & Me.txtCheckNo.Text & "'", SqlCon.SqlCon)
            'Dim cmd As New SqlClient.SqlCommand("SELECT price,accountOwner,accountNo,Serial,ownerBank,bankShobe,bankCode,Date,Tozihat,Passed,Jahate,PardakhtDate,sum(price) as 'جمع کل' From " & DbName & " group by price,accountOwner,accountNo,Serial,ownerBank,bankShobe,bankCode,Date,Tozihat,Passed,Jahate,PardakhtDate having Serial='" & Me.txtCheckNo.Text & "'", SqlCon.SqlCon)
    ...
    Private Function GetSumAll(ByVal DbName As String, ByVal checkNo As String)
        Cu = New Currency
        Dim Value As String = 0
        Dim cmd As New SqlClient.SqlCommand("SELECT Sum(Price) From " & DbName & " where Serial='" & checkNo & "'", SqlCon.SqlCon)
        SqlCon.SqlCon.Open()
        Dim sdr As SqlClient.SqlDataReader = cmd.ExecuteReader
        Try
            While sdr.Read
