...
Public Class rptAghsatFalse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.rptAghsatFalse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAghsatFalse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAghsatFalse = New rptAghsatFalse()
        rpt.Site = Me.Site
        Return rpt
    End Function
