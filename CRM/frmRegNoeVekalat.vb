Public Class frmRegNoeVekalat
    ...
    Private Sub FillGrid()
        ...
        Try
            ...
            Cmd.CommandText = "Select  NoeVekalat as 'نوع وکالت',id as 'کد شناسائی'  from NoeVekalat"
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Cmd.CommandText = "Delete NoeVekalat where Id='" & OfficeID & "'"
        Cmd.Connection = SqlCon.SqlCon
    ...
    Private Sub btnReg_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReg.Click
        Cmd.CommandText = "insert into NoeVekalat (NoeVekalat) values (N'" & Me.txtNoeVekalat.Text & "')"
        Cmd.Connection = SqlCon.SqlCon
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Cmd.CommandText = "Update NoeVekalat set NoeVekalat=N'" & Me.txtNoeVekalat.Text & "' where Id='" & OfficeID & "'"
        Cmd.Connection = SqlCon.SqlCon
    ...
    Private Sub FillTextBox(ByVal GID As String)
        ...
        Dim cmd As New SqlClient.SqlCommand("SELECT NoeVekalat From NoeVekalat where ID='" & GID & "'", SqlCon.SqlCon)
