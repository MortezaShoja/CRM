...
Public Class rptFullReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.rptFullReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFullReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFullReport = New rptFullReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
