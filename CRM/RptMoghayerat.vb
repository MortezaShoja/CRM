...
Public Class RptMoghayerat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mehregan.RptMoghayerat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMoghayerat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMoghayerat = New RptMoghayerat()
        rpt.Site = Me.Site
        Return rpt
    End Function
